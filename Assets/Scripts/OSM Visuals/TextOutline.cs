...
/// <summary>
/// Generates black outline for text in a text mesh by generating 8 copies of the
/// mesh behind the text mesh on each side of the mesh.
/// </summary>
...
public class TextOutline : MonoBehaviour {
	...
	public void CopyTextAttributes() {
	...
	public void UpdateOutline() {
		...
		outlineColor.a = meshRenderer.material.color.a * meshRenderer.material.color.a;
