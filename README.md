...
3DMaps uses files generated by the [mapcreator](https://github.com/3Dmaps/mapcreator) console application, consisting of a height map in binary format, an XML file containing [Open Street Map data](https://github.com/3Dmaps/3Dmaps/osm.md) and a satellite image in .png format.
